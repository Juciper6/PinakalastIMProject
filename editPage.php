...
<body class="bg-gray-300 bg-no-repeat" style="background-image: url('pic/social-media.webp'); background-position: center; background-size: cover; font-family: 'Roboto', Arial, sans-serif; height: 100vh;">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4 relative">
                <div class="flex items-center space-x-3">
                    <img src="pic/icon.webp" alt="Logo" class="w-10 h-10 shadow-sm  border-2 border-gray-200 dark:border-gray-700">
                    <div class="text-lg font-bold text-gray-800 dark:text-white hidden sm:block">
                        <span class="text-sm tracking-wide">JJ</span>
                    </div>
                </div>
    ...
    <div class="flex flex-col justify-center items-center flex-grow px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-xl max-w-md w-full space-y-6 border border-gray-200 dark:border-gray-700">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-center text-gray-900 dark:text-white">EDIT USERS</h1>
            </div>
            ...
            <?php if ($result): ?>
                <form id="editUserForm" method="POST" action="editPage.php?student_id=<?php echo htmlspecialchars($studentIdToFetch); ?>" class="space-y-6">
                    ...
                    <div>
                        <label for="section" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PLATFORM</label>
                        <select id="section" name="section" required
                            ...
                            <?php
                            $sections = ['FACEBOOK', 'INSTAGRAM', 'TWITTER', 'TELEGRAM'];
                    ...
                    <div>
                        <label for="student_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ID</label>
                        <input type="text" name="student_id" id="student_id" value="<?php echo htmlspecialchars($result['student_id']); ?>" placeholder="E.G"
                            class="mt-1 block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-200 rounded-md shadow-sm  sm:text-sm">
                    </div>
