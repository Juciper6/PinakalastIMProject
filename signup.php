...
<body class="h-screen bg-cover bg-no-repeat flex items-center justify-center font-[Roboto]" style="background-image: url('pic/social-media.webp'); background-position: center calc(100% + 100px); font-family: 'Roboto', Arial, sans-serif; backdrop-filter: blur(5px);">
    ...
    <div id="signup-form-container" class="p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-24 backdrop-filter backdrop-blur-2xl">
        <form id="signupFormActual" action="#" method="POST">
            ...
            <div class="mb-4 border-t pt-4">
                <label for="signup-student_id" class="block text-white text-sm font-bold mb-2">Account ID</label>
            ...
            <div class="mb-4">
                <label for="signup-section" class="block text-white text-sm font-bold mb-2">Platform</label>
            ...
            <div class="flex flex-row items-center mb-10">
                <div class="w-1/2 pr-2">
                    ...
                    <input type="password" id="signup-password" name="password"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="*******">
                </div>
        ...
        <div class="mt-6 text-center border-t pt-4">
            <p class="text-sm text-gray-400 mb-2">Check Users Today</p>
                ...
                axios.post("database/handler.php", checkData)
                    .then(function(response) {
                        ...
                        if (response.data.ret == 1) {
                                ...
                                .then(function(responseCreate) {
                                    if (responseCreate.data.ret == 1) {
                                        ...
                                        Swal.fire({
                                            ...
                                            position: 'top-end',
                                            icon: 'error',
                                            title: 'Users could not be created',
                                            showConfirmButton: false,
                                            timer: 2000,
                                            timerProgressBar: true,
                                        });
                            ...
                            Swal.fire({
                                ...
                                position: 'top-end',
                                icon: 'error',
                                title: response.data.msg || 'An unexpected error occurred while checking the Users.',
                                showConfirmButton: false,
                                timer: 2000,
                                timerProgressBar: true,
                    ...
                    .catch(function(error) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Network Error',
                            text: 'Could not reach server to check Users. Please check your connection.'
                        });
                    });
            });
        });
